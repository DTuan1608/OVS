...
void handle_normal_packet(struct ofconn *ofconn, enum ofputil_protocol protocol, const struct ofproto_async_msg *am);
void Add_flow_to_switch(struct flow *tflow);
void handle_tcp_handshake(struct dp_packet *packet_in);
void initiate_tcp_handshake(struct dp_packet *packet_in);
void forward_packet(struct dp_packet *packet_in);
